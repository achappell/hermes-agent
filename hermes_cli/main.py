...
def cmd_dashboard(args):
    ...
    if (
        ...
        # Same-interpreter re-exec (`python -m hermes_cli.main`): the ambient
        # PYTHONPATH must survive the env factory's Hermes-owned strip —
        # under no-boot-through-venv the child's imports arrive through it.
